...
MOVE_STALL_LIMIT = 20
AUTO_CATCH_COOLDOWN_SECONDS = 0.7
AUTO_CATCH_CLEAR_TIMEOUT_SECONDS = 5
AUTO_CATCH_CLEAR_CHECK_INTERVAL_SECONDS = 0.2
AUTO_CATCH_POST_MOVE_DELAY_SECONDS = 0.03
AUTO_CATCH_LOOP_INTERVAL_SECONDS = 0.2
DETECTION_REGION_OFFSET = (5, 157, 1072, 561)
DETECTION_CONFIDENCE = 0.6
BATTLE_IMAGE_DIFF_THRESHOLD = 12
BATTLE_PRE_ACTION_DELAY_SECONDS = 0.7
BATTLE_POST_ACTION_DELAY_SECONDS = 5
BATTLE_CHECK_INTERVAL_SECONDS = 0.1
BATTLE_RESUME_AFTER_R_DELAY_SECONDS = 0.5
